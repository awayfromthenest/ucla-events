...
<!-- *********** CSS for Internet Explorer (ie) ***************	 -->
<!--[if IE]>
	<link rel="stylesheet" src="<?php bloginfo('template_directory'); ?>/ie.css" type="text/css" media="screen" title="no title" charset="utf-8">
<![endif]-->
	<link rel="stylesheet" src="<?php bloginfo('template_directory'); ?>/ie.css" type="text/css" media="screen" title="no title" charset="utf-8">
<!--[if IE 7]>
	<link rel="stylesheet" src="<?php bloginfo('template_directory'); ?>/ie.css" type="text/css" media="screen" title="no title" charset="utf-8">
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-35315460-1']);
